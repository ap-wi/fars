...
## Install
  Any R user can install the package with just two lines of code:
  install.packages("devtools")
  devtools::install_github("ap-wi/package_fars")  

## Usage
    There are three functions in the package fars supported:
    * Reading a file using fars_read(filename)
    * Provision of a dataframe using fars_summarize_years(years)
